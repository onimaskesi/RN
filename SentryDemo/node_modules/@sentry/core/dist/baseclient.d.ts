import { Scope, Session } from '@sentry/hub/src';
import { Client, Event, EventHint, Integration, IntegrationClass, Options, Severity } from '@sentry/types/src';
import { Dsn } from '@sentry/utils';
import { Backend, BackendClass } from '@sentry/core/src/basebackend';
import { IntegrationIndex } from '@sentry/core/src/integration';
/**
